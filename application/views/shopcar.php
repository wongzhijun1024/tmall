...
<div class="concent">
    ...
    <div class="float-bar-wrapper">
        ...
        <div class="float-bar-right">
            ...
            <button class="btn-area" id="settlement" onclick="settlement()">
                <div href="pay.php" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算">
                    <span>结&nbsp;算</span></div>
            </button>
        </div>
    ...
    <div class="theme-popbod dform">
        <form class="theme-signin" name="loginform" action="" method="post">
            ...
            <div class="theme-signin-right">
                <div class="img-info">
                    <img src="<?php echo base_url() ?>/images/kouhong.jpg_80x80.jpg" />
                </div>
                <div class="text-info">
