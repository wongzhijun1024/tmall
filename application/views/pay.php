...
<head>
    <script type="text/javascript">
        var base_url2 ="<?php echo site_url('successcontrollers')?>"
    </script>
...
<div class="concent">
    ...
    <div class="paycont">
        ...
        <div class="logistics">
            <h3>选择支付方式</h3>
            <ul class="pay-list">
                <li class="pay card"><img src="<?php echo base_url() ?>/images/wangyin.jpg" />银联<span></span></li>
                <li class="pay qq"><img src="<?php echo base_url() ?>/images/weizhifu.jpg" />微信<span></span></li>
                <li class="pay taobao"><img src="<?php echo base_url() ?>/images/zhifubao.jpg" />支付宝<span></span></li>
            </ul>
        </div>
        <div class="clear"></div>
            ...
            <div class="pay-confirm clearfix">
                ...
                <div id="holyshit269" class="submitOrder">
                    <div class="go-btn-wrap">
                        <button id="submitodr" onclick="submitodr()" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</button>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
