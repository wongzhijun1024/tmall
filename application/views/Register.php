				...
				<div class="login-box">
                 ...
                 <div class="user-pass">
								 ...
								 <div class="login-links">
										...
										<div class="am-cf">
											<input type="button"  id="butn2" name="" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
										</div>
...
<!--								<script>
	...
	/*if($name.length < 1 || $usename.length>32){
	...
	if($passwd.length < 6 || $passwd.length>18){
		...
		$('#passwd').next('.err').html('请输入6-18位密码');
  ...
  var url ="<?php echo site_url('registerController/insertuser')?>";
                  ...
                  $.ajax({
                      ...
                      success:function(msg){  //处理正确时的信息
                       ...
                       alert(msg);
                        ...
                        var url = "<?php echo site_url('regisc')?>";
