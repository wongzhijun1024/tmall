...
<head>
    ...
    <link href="<? echo base_url()?>/css/css/optstyle.css" type="text/css" rel="stylesheet">
    <link href="<? echo base_url()?>/css/css/style.css" type="text/css" rel="stylesheet">
...
<!--    <script src="http://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js" ></script>-->
    ...
    <script src="<? echo base_url()?>/css/assets/js/amazeui.js" type="text/javascript" ></script>
    <script src="<? echo base_url()?>/css/js/jquery.imagezoom.min.js" type="text/javascript" ></script>
    <script src="<? echo base_url()?>/css/js/jquery.flexslider.js" type="text/javascript" ></script>
    <script src="<? echo base_url()?>/css/js/list.js" type="text/javascript" ></script>
...
<div class="listMain">
    ...
    <div class="item-inform">
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="<? echo base_url()?>./images/01.jpg"><img src="
                    <?php
                        $imageUrl = base_url()."images/";
                        foreach ($payforshop as $key){
                            $url = $imageUrl.$key['file'];
                            echo $url;
                        }
                        ?>
            " alt="细节展示放大镜特效" rel="<? echo base_url()?>./images/01.jpg" class="jqzoom" /></a>
                </div>
        ...
        <div class="clearfixRight">
            ...
            <!--规格属性-->
            <!--名称-->
            <div class="tb-detail-hd" id="subname">
                <h1><?php foreach ($payforshop as $key){echo $key['name2'];} ?></h1>
            </div>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <!--设置一个隐藏的盒子存放图片的ID-->
                        <div id="imgid" style="display: none"><?php   foreach ($payforshop as $key){
                                echo $key['imgid'];
                            } ?></div>

                        <dd><em>¥</em><b class="sys_item_price" id="price"><?php   foreach ($payforshop as $key){
                                    echo $key['price'];
                                } ?></b>  </dd>
                    ...
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice"><?php   foreach ($payforshop as $key){
                                    echo $key['oldprice'];
                                } ?></b></dd>
                    </li>
                    <div class="clear"></div>
                                ...
                                <form class="theme-signin" name="loginform" action="" method="post">
                                    ...
                                    <div class="theme-signin-left">
                                        ...
                                        <div class="theme-options">
                                            ...
                                            <ul  id="taste">
                                                <li class="sku-line selected intcart1">原味</li>
                                                <li class="sku-line intcart2">奶油</li>
                                                <li class="sku-line intcart3" >炭烧</li>
                                                <li class="sku-line intcart4">咸香</li>
                                            </ul>
                                        </div>
                                        <div class="theme-options">
        ...
        <div class="theme-signin-right">
            <div class="img-info">
                <img src="<? echo base_url()?>./images/songzi.jpg" />
            </div>
            <div class="text-info">
...
<div class="pay" >
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login" style="position: absolute; left: 580px; top: 630px; ">
            <a id="LikBuy" title="点此按钮到下一步确认购买信息" ><div id="shoping">立即购买</div></a>
        </div>
    </li>
    <script>
        var str;
        $("#shoping").click(function fn() {
            ...
            $.ajax({
                type:"post",
                url: "<?php echo site_url('shopingcarController/updata')?>",
                async:true,
                data:{
                    name:name,
                    price:price,
        ...
        $("#taste").delegate("li","click",function () {
             str = $(this).html();
            //console.log(str)
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login" style="position: absolute; left: 530px; top: 630px; ">
            <a id="LikBasket" title="加入购物车"><i></i><div id="shopcar">加入购物车</div></a>
        </div>
    </li>
    <script>
        var str;
...
<div class="match">
    ...
    <div class="match-comment">
        <ul class="like_list">
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="<? echo base_url()?>./images/cp.jpg"></a>
            ...
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="<? echo base_url()?>./images/cp2.jpg"></a>
    ...
    <div class="browse">
        <div class="mc">
            <ul>
                ...
                <li class="first">
                    <div class="p-img">
                        <a  href="#"> <img class="" src="<? echo base_url()?>./images/browse1.jpg"> </a>
                    </div>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <img src="<? echo base_url()?>./images/tw1.jpg" />
                            <img src="<? echo base_url()?>./images/tw2.jpg" />
                            <img src="<? echo base_url()?>./images/tw3.jpg" />
                            <img src="<? echo base_url()?>./images/tw4.jpg" />
                            <img src="<? echo base_url()?>./images/tw5.jpg" />
                            <img src="<? echo base_url()?>./images/tw6.jpg" />
                            <img src="<? echo base_url()?>./images/tw7.jpg" />
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="am-tab-panel am-fade">
                    ...
                    <ul class="am-comments-list am-comments-list-flip">
                        <li class="am-comment">
                            <!-- 评论容器 -->
                            <a href="">
                                <img class="am-comment-avatar" src="<? echo base_url()?>./images/hwbn40x40.jpg" />
                                <!-- 评论者头像 -->
                            </a>
