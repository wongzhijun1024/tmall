...
<head>
    ...
    <title>付款成功页面</title>
    <link rel="stylesheet"  type="text/css" href="<?php echo base_url() ?>/AmazeUI-2.4.2/assets/css/amazeui.css"/>
    ...
    <link href="<?php echo base_url() ?>/css/sustyle.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="<?php echo base_url() ?>/basic/js/jquery-1.7.min.js"></script>
    ...
    <div class="status">
        ...
        <div class="successInfo">
            ...
            <div class="option">
                ...
                <a href="<?php echo base_url() ?>/person/order.html" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
                <a href="<?php echo base_url() ?>/person/orderinfo.html" class="J_MakePoint">查看<span>交易详情</span></a>
            </div>
        </div>
    </div>
</div>
